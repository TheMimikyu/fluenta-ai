      ...
      <div className="container mx-auto px-4 pt-20 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          {features.map((feature, index) => (
            <div
              key={index}
              className="floating-card bg-white p-6 rounded-2xl shadow-sm"
            >
...
const features = [
  {
    ...
    description:
      "Practice real-life scenarios with our advanced AI language model",
  },
  {
    icon: (
      <svg
...
const steps = [
  {
    ...
    description:
      "Select from various real-life situations and difficulty levels",
  },
  {
