    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto px-4 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center animate-in">
          <h1 className="font-bold text-gray-900 mb-6 text-8xl">Fluenta AI</h1>
          <p className="text-gray-600 mb-4 text-4xl">
            Fluency, One Conversation at a Time
          </p>
          <p className="text-xl text-gray-600 mb-8">
            Practice Conversations, Perfect Pronunciation, and Track Progress with
            your own Personal tutoring AI.
          </p>
          <Button
            onClick={() => navigate("/practice")}
            size="lg"
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          {features.map((feature, index) => (
            <div key={index} className="floating-card bg-white p-6 rounded-2xl shadow-sm">
